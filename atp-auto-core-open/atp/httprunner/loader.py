...
import yaml
from atp.httprunner import built_in, exceptions, logger, parser, utils, validator
from atp.httprunner.compat import OrderedDict
# from atp.utils import custom
...
def load_builtin_module():
    ...
    # print(built_in_module)
    project_mapping["debugtalk"] = built_in_module
    custom_module = load_python_module(custom)
    # print(custom_module)
    project_mapping["debugtalk"]["functions"].update(custom_module["functions"])
