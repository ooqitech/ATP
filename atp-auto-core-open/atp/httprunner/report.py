...
from atp.httprunner import loader, logger
from atp.httprunner.__about__ import __version__
from atp.httprunner.compat import basestring, bytes, json, numeric_types
...
def render_html_report(summary, html_report_name=None, html_report_template=None, html_report_dir=None):
