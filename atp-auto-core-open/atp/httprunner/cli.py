...
from atp.httprunner.__about__ import __description__, __version__
from atp.httprunner.compat import is_py2
from atp.httprunner.api import HttpRunner
from atp.httprunner.utils import (create_scaffold, get_python2_retire_msg,
...
def main_locust():
    ...
    try:
        from atp.httprunner import locusts
    except ImportError:
