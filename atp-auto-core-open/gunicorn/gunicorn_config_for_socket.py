...
bind = "%s:%s" % ("0.0.0.0", 7500)

access_log_format = '%(h)s %(l)s %(u)s %(t)s "%(r)s" %(U)s %(q)s %(s)s %(b)s "%(f)s" "%(a)s" %(D)s %(T)s %(i)s %(o)s %(e)s'


errorlog = '/usr/local/src/logs/atp-auto-core/gunicorn_socket_error.log'
accesslog = '/usr/local/src/logs/atp-auto-core/gunicorn_socket_access.log'
