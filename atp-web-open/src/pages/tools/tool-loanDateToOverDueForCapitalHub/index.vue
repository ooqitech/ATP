<template>
  <d2-container>
    <el-card class="box-card">
      ...
      <div class="text item">1、loan_hub.loan_hub_loan表中有记录且LOAN_STATUS是已放款（50）/已逾期（60）</div>
      <div class="text item">2、loan_hub.loan_hub_loan表中CAPITAL_NO为057</div>
      <div class="text item">3、loan_hub.loan_hub_repay_plan表有与期数相同数量的记录</div>
    </el-card>
    <!--更新还款计划-->
    <el-card class="box-card">
      <div slot="header" class="clearfix">
