...
export function listSmokingTask(data) {
  return request({
    url: '/atp/auto/apiTask/listSmokingTask',
    method: 'post',
    data
  })
}
...
export function exportSmokingTestLogToExcel(data) {
  return request({
    url: '/atp/auto/apiTask/exportSmokingTestLogToExcel',
    method: 'post',
    data
  })
}
